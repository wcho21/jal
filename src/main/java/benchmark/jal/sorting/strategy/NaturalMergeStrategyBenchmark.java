...
@State(Scope.Thread)
public class NaturalMergeStrategyBenchmark {
  Integer[] reversed;
  Integer[] sorted;
  ...
  public Integer[] measureWorst() {
    ...
    Sorter.sortArray(toSort, new NaturalMergeStrategy<>());
  ...
  public Integer[] measureBest() {
    Integer[] sorted = Sorter.sortArray(this.sorted, new NaturalMergeStrategy<>());
